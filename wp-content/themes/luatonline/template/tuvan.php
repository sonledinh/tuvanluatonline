<?php /* Template Name: tuvan */ ?>
<?php 
global $wp;
$link_cur = home_url( $wp->request );
$query = $_SERVER['QUERY_STRING'];
$parent = $terms = get_terms( array(
    'taxonomy' => 'category',
    'hide_empty' => false,
    'parent' => 7,
) );
					...
					<div class="bar-category">
						<div class="date-notice">
							<ul>
								...
								?>
									<li><a href="/tu-van-hoi-dap/?<?php echo $value->term_id; ?>"><i class="fa fa-caret-right"></i><?php echo $value->name; ?></a></li>
								<?php 
								}
								?>
